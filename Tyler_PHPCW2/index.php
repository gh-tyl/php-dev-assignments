  ...
  <div class="col-5">
    ...
    <form method="POST" action="<?php echo $baseName . 'log.php'; ?>">
      ...
      <div class="form-floating mb-3">
        <!-- <input type="email" class="form-control" name="email" placeholder="cd" required> -->
        <input type="email" class="form-control" name="email" placeholder="cd">
        <label for="email">Email</label>
      </div>
      <div class="form-floating mb-3">
        <!-- <input type="password" class="form-control" name="pass" placeholder="cd" required> -->
        <input type="password" class="form-control" name="pass" placeholder="cd">
